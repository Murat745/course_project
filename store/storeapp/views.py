...
from storeapp.my_cart import MyCart
from storeapp.forms import BookSearchForm, ModifiedUserCreationForm, PriceFilterForm, UserAddressForm
from storeapp.models import Book, Order, OrderItem
from storeapp.tasks import create_order_in_api as celery_create_order
...
class OrderList(LoginRequiredMixin, generic.ListView):
    model = Order
    template_name = 'storeapp/my_orders.html'
